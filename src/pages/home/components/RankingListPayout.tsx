...
export default function RankingListPayout() {
  ...
  const initialCasinos = [
    {
      ...
      paymentMethods: ['apple', 'google', 'payid', 'osko', 'amopay']
    },
    {
      rank: 2,
      name: '🎲 KINGBET9',
  ...
  const paymentIcons: Record<string, string> = {
    ...
    master: '/payment/master.png',
    apple: '/payment/apple.png',
    google: '/payment/google.png',
    osko: '/payment/osko.png',
    amopay: '/payment/amopay.png',
    payid:'/payment/payid.png',
    speedpay:'payment/speedpay.png',
  };

  return (
    <section id="recommended-payout-casino" className="py-8 md:py-10 mb-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-6 md:mb-12 text-center">
          Australia Instant Payout eWallet Casinos for Real Money Players
        </h1>
              ...
              <div className="hidden md:flex items-center p-6">
                ...
                <div className="flex items-center space-x-4 pr-6 border-r border-gray-200" style={{ width: '28%' }}>
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -left-1 w-8 h-8 bg-[#1bff1b] rounded-full flex items-center justify-center text-black font-bold text-sm shadow-md">
                      {casino.rank}
                    </div>
                  </div>
              ...
              <div className="md:hidden p-4">
                <div className="flex items-start space-x-3 mb-4">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-1 -left-1 w-7 h-7 bg-[#1bff1b] rounded-full flex items-center justify-center text-black font-bold text-xs shadow-md">
                      {casino.rank}
                    </div>
                  </div>
